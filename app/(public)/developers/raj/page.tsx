...
export default function DeveloperPage() {
  ...
  const stats = [
    { label: "B.Tech CSE", value: "8.4 CGPA", desc: "MITS-DU, Gwalior", color: "border-white text-white" },
    ...
    { label: "Certifications", value: "3 Active", desc: "See credentials tab", color: "border-white text-white" }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
          ...
          >
            ...
            <div className="w-24 h-24 sm:w-28 sm:h-28 bg-white/10 rounded-full border-2 border-[#434655] flex flex-col items-center justify-center shadow-[4px_4px_0px_#00000040] shrink-0 hover:border-[#346ef6]/50 transition-colors duration-200">
              <span className="font-heading font-black text-2xl text-white mt-1">RK</span>
                ...
                <div className="lg:col-span-7 space-y-4">
                  <div className="bg-[#1d1f28] border-2 border-[#434655] rounded-xl p-5 shadow-[6px_6px_0px_theme(colors.gray.500/10)] hover:border-[#346ef6]/50 transition-colors duration-200">
                    ...
                    <div className="text-xs sm:text-sm text-neutral-200 font-medium leading-relaxed">
                      <p>
                        Computer Science student at Madhav Institute of Technology &amp; Science – Deemed University, Gwalior. I specialize in the front-end layer of the Next.js ecosystem, with a deep focus on design systems, custom animations, and clean layouts, while maintaining solid full-stack understanding. I ensure everything we build is not only performant but also visually striking and highly accessible. Currently co-building StayZ with Utkarsh Soni.
                      </p>
                    </div>
                    ...
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      ...
                      <div className="flex gap-2 items-start bg-neutral-800/40 border border-[#434655] p-2.5 rounded shadow-[1.5px_1.5px_0px_theme(colors.gray.500/10)] hover:border-[#346ef6]/50 transition-colors duration-200">
                        ...
                        <div>
                          <div className="font-bold text-white text-[10px] uppercase tracking-wide">UI/UX Design Systems</div>
                          <p className="text-[9px] text-neutral-300 font-semibold mt-0.5 leading-tight">Figma design tokens & responsive components.</p>
                        </div>
                      </div>
                      <div className="flex gap-2 items-start bg-neutral-800/40 border border-[#434655] p-2.5 rounded shadow-[1.5px_1.5px_0px_theme(colors.gray.500/10)] hover:border-[#346ef6]/50 transition-colors duration-200">
                        <Brain size={14} className="text-white mt-0.5 shrink-0" />
                        <div>
                          <div className="font-bold text-white text-[10px] uppercase tracking-wide">Excalidraw Integration</div>
                          <p className="text-[9px] text-neutral-300 font-semibold mt-0.5 leading-tight">Real-time collaboration & custom canvas items.</p>
                        </div>
                      </div>
                      <div className="flex gap-2 items-start bg-neutral-800/40 border border-[#434655] p-2.5 rounded shadow-[1.5px_1.5px_0px_theme(colors.gray.500/10)] hover:border-[#346ef6]/50 transition-colors duration-200">
                        <Server size={14} className="text-white mt-0.5 shrink-0" />
                        <div>
                          <div className="font-bold text-white text-[10px] uppercase tracking-wide">Front-end Polish</div>
                          <p className="text-[9px] text-neutral-300 font-semibold mt-0.5 leading-tight">Framer Motion, animations & transitions.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                      ...
                      <ul className="text-[11px] text-neutral-400 font-semibold space-y-1.5 mb-6">
                        <li className="flex items-start gap-1.5">
                          ...
                          <span>Excalidraw canvas with AI image generation inserted directly onto it.</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-white text-xs mt-0.5">•</span>
                        ...
                        <li className="flex items-start gap-1.5">
                          <span className="text-white text-xs mt-0.5">•</span>
                          <span>Two-window AI rate limiting for text vs. image generation routes.</span>
                        </li>
                      </ul>
                    </div>
                    <div className="flex flex-wrap gap-2.5">
                      <a
                        href="https://github.com/RAJ-TECH-11/DraftSpace"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-neutral-950 text-white border-2 border-[#434655] rounded-md font-bold text-[11px] shadow-[2px_2px_0px_theme(colors.gray.500/10)] hover:translate-x-[1px] hover:translate-y-[1px] hover:border-[#346ef6]/50 hover:shadow-[1px_1px_0px_#00000040] transition-all duration-200"
                      >
                  ...
                  <div className="bg-[#1d1f28] border-2 border-[#434655] rounded-xl p-6 shadow-[6px_6px_0px_theme(colors.gray.500/10)] flex flex-col justify-between relative overflow-hidden hover:-translate-y-0.5 hover:border-[#346ef6]/50 transition-all duration-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-300 font-medium mb-4 leading-relaxed">
                        A dynamic and interactive listings portal layout, supporting filtering, wishlist states, and premium user interaction flows.
                      </p>
                      <ul className="text-[11px] text-neutral-400 font-semibold space-y-1.5 mb-6">
                        <li className="flex items-start gap-1.5">
                          <span className="text-white text-xs mt-0.5">•</span>
                          <span>Fully responsive and custom components.</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-white text-xs mt-0.5">•</span>
                          <span>Figma design implementation.</span>
                        </li>
                      </ul>
                    </div>
                    <div className="flex flex-wrap gap-2.5">
                      <a
                        href="https://github.com/RAJ-TECH-11/stayz"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-neutral-950 text-white border-2 border-[#434655] rounded-md font-bold text-[11px] shadow-[2px_2px_0px_theme(colors.gray.500/10)] hover:translate-x-[1px] hover:translate-y-[1px] hover:border-[#346ef6]/50 hover:shadow-[1px_1px_0px_#00000040] transition-all duration-200"
                      >
                  ...
                  <div className="bg-[#1d1f28] border-2 border-[#434655] rounded-xl p-6 shadow-[6px_6px_0px_theme(colors.gray.500/10)] flex flex-col justify-between relative overflow-hidden hover:-translate-y-0.5 hover:border-[#346ef6]/50 transition-all duration-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-300 font-medium mb-4 leading-relaxed">
                        A retro-modern terminal-like user interface for an offline intent classifier and NLP chatbot, styled with custom CSS.
                      </p>
                      <ul className="text-[11px] text-neutral-400 font-semibold space-y-1.5 mb-6">
                        <li className="flex items-start gap-1.5">
                          <span className="text-white text-xs mt-0.5">•</span>
                          <span>Clean chat window bubble aesthetics.</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-white text-xs mt-0.5">•</span>
                          <span>Responsive layout adjustments.</span>
                        </li>
                      </ul>
                    </div>
                    <div className="flex flex-wrap gap-2.5">
                      <a
                        href="https://github.com/RAJ-TECH-11/nlp-chatbot"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <div className="bg-[#1d1f28] border-2 border-[#434655] rounded-xl p-6 shadow-[6px_6px_0px_theme(colors.gray.500/10)] hover:border-[#346ef6]/50 transition-colors duration-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="bg-neutral-800/30 border-2 border-[#434655] p-5 rounded-lg shadow-[3px_3px_0px_theme(colors.gray.500/10)] flex flex-col justify-between hover:-translate-y-0.5 hover:border-[#346ef6]/50 transition-all">
                      <div>
                        <div className="w-10 h-10 rounded bg-white/10 border border-[#434655] flex items-center justify-center mb-4">
                          <Award size={18} className="text-white" />
                        </div>
                        <h4 className="font-bold text-white text-sm leading-tight">Meta Frontend Developer</h4>
                        <p className="text-[10px] text-neutral-300 font-extrabold mt-1">Issued by — Meta / Coursera</p>
                      </div>
                      <div className="flex justify-between items-center mt-6">
                        ...
                        <span className="text-[9px] font-bold text-white uppercase tracking-wider">Frontend</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-neutral-800/30 border-2 border-[#434655] p-5 rounded-lg shadow-[3px_3px_0px_theme(colors.gray.500/10)] flex flex-col justify-between hover:-translate-y-0.5 hover:border-[#346ef6]/50 transition-all duration-200">
                      <div>
                        ...
                        <h4 className="font-bold text-white text-sm leading-tight">UI/UX Design Specialization</h4>
                        <p className="text-[10px] text-neutral-300 font-extrabold mt-1">Issued by — California Institute of the Arts</p>
                      </div>
                      <div className="flex justify-between items-center mt-6">
                        <span className="text-[9px] font-bold font-mono bg-neutral-800 border border-[#434655] rounded px-1.5 py-0.5 text-neutral-300">2024</span>
                        <span className="text-[9px] font-bold text-white uppercase tracking-wider">UI/UX</span>
                      </div>
                    </div>
